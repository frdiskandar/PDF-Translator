...
pinned: false
license: apache-2.0
short_description: Local-first PDF translator with side-by-side bilingual reading and on-demand per-page translation
---

# PDF Translator: A PDF Reader/Translator with Local LLM/ChatGPT or Google
...
![PDF Translator ](PDF-Translator-for-Human.jpg)
...
## Start the Web Application for PDF Translator
